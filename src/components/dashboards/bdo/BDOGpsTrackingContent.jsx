...
const BDOGpsTrackingContent = () => {
    ...
    // Fetch vehicles from API based on BDO's location context
    const { data: vehiclesData = [], isLoading: isLoadingVehicles, error: vehiclesError } = useVehicles({
        districtId: selectedLocation?.districtId || selectedLocation?.bdoDistrictId || 1,
        blockId: selectedLocation?.blockId || selectedLocation?.bdoBlockId || 1,
        gpId: selectedLocation?.gpId || 1,
    });
    ...
    return (
        <div style={{ minHeight: '100vh', backgroundColor: '#F3F4F6' }}>
            ...
            <div style={{
                ...
                {/* Right side - Scope buttons and Location display */}
                <div style={{
                    display: 'flex',
                    alignItems: 'center',
                    gap: '16px'
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <span>
                                {selectedLocation?.block || 'No location selected'}
                                {selectedLocation?.gp && ` - ${selectedLocation.gp}`}
                            </span>
                        </div>
                    </div>
                </div>

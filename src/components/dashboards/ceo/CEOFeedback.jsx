...
import { MessageSquare, Search, X, Info, ChevronDown, Star } from 'lucide-react';
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '24px' }}>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                ...
                <Tooltip text={getTooltipText('AVERAGE_RATING')}>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                ...
                <Tooltip text={getTooltipText('TOTAL_RATINGS')}>
                  <Info size={16} color="#9CA3AF" style={{ cursor: 'help' }} />
                </Tooltip>
              </div>
              <div style={{ fontSize: '36px', fontWeight: 'bold', color: '#111827', marginBottom: '16px' }}>
...
export default CEOFeedbackContent;
